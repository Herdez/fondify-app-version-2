...
# @project_1 = Project.create(user_id: @user2.id, title: "Prueba 1", description: "Proyecto social", image: File.new("#{Rails.root}/app/assets/images/logo.png"), status: false)
